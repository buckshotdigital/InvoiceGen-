        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex-1 py-3 px-4 bg-primary-600 text-white rounded-md font-medium hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {downloading ? (
                <>
