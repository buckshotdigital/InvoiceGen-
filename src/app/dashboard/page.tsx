                  ...
                  {invoices.map((invoice) => {
                    ...
                    return (
                      <tr key={invoice.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {invoice.isPaid ? (
                            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-semibold rounded-full bg-green-500 text-white shadow-sm">
                            ...
                            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-semibold rounded-full bg-red-500 text-white shadow-sm">
                              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-full bg-yellow-100 text-yellow-800 border border-yellow-300">
                              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
