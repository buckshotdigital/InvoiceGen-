                  ...
                  {invoices.map((invoice) => {
                    ...
                    return (
                      <tr key={invoice.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-3 py-3 whitespace-nowrap">
                          {invoice.isPaid ? (
                            <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded-full bg-green-500 text-white">
                            ...
                            <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded-full bg-red-500 text-white">
                              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <td className="px-3 py-3 whitespace-nowrap hidden lg:table-cell">
                          {invoice.lastReminderSent || invoice.last_reminder_sent ? (
                            ...
                            >
                              {invoice.reminderCount || invoice.reminder_count || 1}x sent
                            </button>
                          ) : (
